...
let fallbackQuotes = [
  ...
  "美将拯救世界。——陀思妥耶夫斯基",
  "人类从历史中学到的唯一教训，就是人类从不从历史中吸取教训。——黑格尔",
  "优于别人，并不高贵；真正的高贵应该是优于过去的自己。——海明威",
  "世界以痛吻我，要我报之以歌。——泰戈尔",
  "如果你独处时感到寂寞，这说明你没有和你自己成为好朋友。——萨特",
  "心之所向，素履以往。——七堇年",
  "Carpe diem. Seize the day. Make your lives extraordinary. ——《死亡诗社》",
  "人有悲欢离合，月有阴晴圆缺，此事古难全。——苏轼",
  "欲买桂花同载酒，终不似，少年游。——刘过",
  "没有什么比时间更有说服力了，因为时间无需通知我们就可以改变一切。——余华",
  ...
  "我走得很慢，但我从不后退。——林肯",
  "读书不是为了拿文凭或者发财，而是成为一个有温度懂情趣会思考的人。——杨绛",
  "今天不想跑，所以才去跑，这才是长跑者的思维方式。——村上春树",
  "成年人最大的体面，就是及时止损。——佚名",
  "你没那么多观众，别那么累。——佚名",
  "愿你出走半生，归来仍是少年。——佚名",
  "这辈子很短，所以要大胆一点，去攀一座山，去追一个梦，去爱一个人。——佚名"
];
